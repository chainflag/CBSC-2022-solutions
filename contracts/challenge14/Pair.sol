...
contract MdexPair  {
    ...
    function _update(uint balance0, uint balance1, uint _reserve0, uint _reserve1) private {
        // require(balance0 <= uint(- 1) && balance1 <= uint(- 1), 'MdexSwap: OVERFLOW');
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        if(flash){
            ...
            require(999*_reserve0/1000<=balance0&&balance0<=1001*_reserve0/1000);


            require(999*_reserve1/1000<=balance1&&balance1<=1001*_reserve1/1000);
