...
interface ITTRouter02 is ITTRouter01 {
}

interface ITTFactory {
...
interface ITTCallee {
    function TTCall(address sender, uint amount0, uint amount1, bytes calldata data) external;
}
